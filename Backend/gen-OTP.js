...
const client = require("./API_keys");

const docClient = new AWS.DynamoDB.DocumentClient({ region: "us-east-2" });
const tableName = ""; //Table name in DynamoDB

const { CLIENT_ID, CLIENT_SECRET, REDIRECT_URI, REFRESH_TOKEN } = client;
...
exports.handler = (event, context, callback) => {
  ...
  //Function to the send the mail using nodemailer
